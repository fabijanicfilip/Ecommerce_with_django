...
class ProductSpecification(models.Model):
    """
    The Product Specification Table conatins product
...
class ProductSpecificationValue(models.Model):
    """
    The Product Specification Value table holds each of
    the products individual specifications or bespoke features.
    """
