...
urlpatterns = [
    # Za ovo nije potrebno raditi view jer je vec napravljen u django authentication system, samo je u logout path next_page stavljen da vodi korisnika na login jednom kada se izlogira
    ...
    path('delete_confirm/', TemplateView.as_view(template_name='account/dashboard/delete_confirm.html'), name='delete_confirmation'),
]